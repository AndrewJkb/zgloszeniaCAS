...
$sql = 'Select count(*) from `zgloszenia` WHERE `status`=1';
...
echo '<div class="panel panel-default">
		<div class="panel-heading"><center><h5><b>Wszystkie zamknięte zgłoszenia</b></h5></center></div>
		</div>';		
 
//Pobranie odpowieniej paczki
$sql = "SELECT zgloszenia.id,zgloszenia.ticketID,zgloszenia.jednostka_zglaszajaca,zgloszenia.lokalizacja,zgloszenia.date_add,zgloszenia.jednostka_zglaszajaca,zgloszenia.temat,
zgloszenia.osoba_kontaktowa,zgloszenia.telefon,members.id as memid, members.username,status_zgloszen.opis_statusu,grupa.nazwa as obszar
FROM zgloszenia,members,status_zgloszen,grupa 
WHERE zgloszenia.przypisany=members.id AND zgloszenia.status=status_zgloszen.id_statusu AND zgloszenia.status=1 AND zgloszenia.grupa = grupa.grupaid
...
echo '<div class="panel panel-default">
        ...
        <h5>Przypisany do:&nbsp&nbsp<b>'.ucfirst($przypisany).'</b></h5><br /><br /><br />
