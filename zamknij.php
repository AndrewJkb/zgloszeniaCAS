...
include "php/db_connect.php";
		...
		$sql = "UPDATE zgloszenia SET status = 1 WHERE zgloszenia.id =$getid";
		   $wynik = mysql_query($sql) or die('Błąd zapytania '.mysql_error());
		   
		$sql1 = "INSERT INTO historia_zmian (log_id, user_id, id_zgl, log_data, log_typ_zmiany) VALUES('',$user,$getid,now(),'Zgłoszenie zamknięte')";
