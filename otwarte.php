...
echo '<div class="panel panel-default">
		<div class="panel-heading"><center><h5><b>Wszystkie otwarte zgłoszenia</b></h5></center></div>
		</div>';
...
FROM zgloszenia,members,grupa WHERE zgloszenia.status=0 AND zgloszenia.grupa = $session_grupa AND zgloszenia.przypisany = members.id AND zgloszenia.grupa = grupa.grupaid
