...
$email = strtolower(phpCAS::getAttribute('mail'));
				...
				//echo 'Znam Cię :) - jesteś w zarejestorwanym userem';
					...
					echo $username2.'&nbsp&nbsp==&nbsp&nbsp '.$username1.'<br />';
					echo $email2 .'&nbsp&nbsp==&nbsp&nbsp '.$email.'<br />';
					echo $id_user_cas2 .'&nbsp&nbsp==&nbsp&nbsp'.$cas_id.'<br /><br /><br />';
					echo $fullname;
