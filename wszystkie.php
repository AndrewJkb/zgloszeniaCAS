...
echo '<div class="panel panel-default">
		<div class="panel-heading"><center><h5><b>Wszystkie zgłoszenia</b></h5></center></div>
		</div>';


//Pobranie odpowieniej paczki
//$sql = 'SELECT * FROM zgloszenia ORDER BY date_add DESC Limit '.$count.' offset '.$offset.';';
$sql ="SELECT zgloszenia.id,zgloszenia.ticketID,zgloszenia.date_add,zgloszenia.jednostka_zglaszajaca,zgloszenia.lokalizacja,
zgloszenia.temat,zgloszenia.osoba_kontaktowa,zgloszenia.telefon, members.id as memid, members.username,status_zgloszen.opis_statusu,
grupa.nazwa as obszar 
FROM zgloszenia,members,status_zgloszen,grupa 
WHERE zgloszenia.przypisany=members.id AND zgloszenia.status=status_zgloszen.id_statusu AND zgloszenia.grupa = grupa.grupaid 
