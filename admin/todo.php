...
echo '<div class="panel panel-default">
	...
	<h4><b>Pomysły/Sugestie zmian</b></h4><br><p>
	<ol>';		

include "../php/db_connect.php";
$sql = "SELECT do_zrobienia.id,do_zrobienia.tekst,do_zrobienia.status,members.username FROM do_zrobienia,members WHERE do_zrobienia.kto_dodal = members.id AND do_zrobienia.status = 0 Limit $limit, $onpage";
...
echo '<li>&nbsp<b>'.strip_tags(ucfirst($tekst)).'</b> - Zamknij: <input type="checkbox" name='.$id.'><br /><span style="font-size: 12px; font-weight: bold;">Dodał:&nbsp'.ucfirst($user).'</span></li><br />';
}
echo '</ol></p>
<center>
...
<button type="submit" name="Aktualizuj" value="Aktualizuj" class="w3-btn w3-theme-d1 w3-margin-bottom">Dodaj</button>
	</form></center></div>';
